...
class SettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'user_account_deletion_enabled' => ['nullable', 'boolean'],
            'razorpay_enabled' => ['nullable', 'boolean'],
            'razorpay_key_id' => ['nullable', 'string', 'max:255'],
            'razorpay_key_secret' => ['nullable', 'string', 'max:255'],
            'razorpay_webhook_secret' => ['nullable', 'string', 'max:255'],
            'razorpay_merchant_name' => ['nullable', 'string', 'max:255'],
            'razorpay_logo_url' => ['nullable', 'url'],
            'booking_advance_percentage' => ['required', 'numeric', 'min:1', 'max:100'],
            'global_maintenance_mode' => ['nullable', 'boolean'],
            'maintenance_message' => ['nullable', 'string', 'max:500'],
            'user_welcome_dialog_enabled' => ['nullable', 'boolean'],
            'user_welcome_dialog_title' => ['nullable', 'string', 'max:120'],
            'user_welcome_dialog_message' => ['nullable', 'string', 'max:1000'],
            'user_welcome_dialog_image_url' => ['nullable', 'url'],
            'user_welcome_dialog_primary_button_text' => ['nullable', 'string', 'max:40'],
            'user_welcome_dialog_primary_button_action_type' => ['nullable', 'in:none,dismiss,url,route'],
            'user_welcome_dialog_primary_button_action_value' => ['nullable', 'string', 'max:500'],
            'user_welcome_dialog_secondary_button_text' => ['nullable', 'string', 'max:40'],
            'user_welcome_dialog_secondary_button_action_type' => ['nullable', 'in:none,dismiss,url,route'],
            'user_welcome_dialog_secondary_button_action_value' => ['nullable', 'string', 'max:500'],
            'user_welcome_dialog_dismissible' => ['nullable', 'boolean'],
